...
def post_model_devi (iter_index, 
    ...
    if generalML == True:
       ...
       command += "&& python3 inference.py --config config_energy_force --config_spec \"{'data_config.path':'traj.hdf5','batch_size':32}\" --model_path ../best.000.pt --output_keys forces --output_path f_pred0.hdf5" 
       command += "&& python3 inference.py --config config_energy_force --config_spec \"{'data_config.path':'traj.hdf5','batch_size':32}\" --model_path ../best.001.pt --output_keys forces --output_path f_pred1.hdf5"
       command += "&& python3 inference.py --config config_energy_force --config_spec \"{'data_config.path':'traj.hdf5','batch_size':32}\" --model_path ../best.002.pt --output_keys forces --output_path f_pred2.hdf5"
       command += "&& python3 inference.py --config config_energy_force --config_spec \"{'data_config.path':'traj.hdf5','batch_size':32}\" --model_path ../best.003.pt --output_keys forces --output_path f_pred3.hdf5"
